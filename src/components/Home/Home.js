        ...
        <div>
            <div className='flex md:flex-row flex-col-reverse justify-between w-[80%] mx-auto mt-10 p-5 bg-slate-300 rounded-lg shadow-lg'>
                <div className='md:w-1/2 place-self-center md:mr-8 md:mt-0 mt-4'>
                    ...
                    <button className='mt-6 text-xl text-white hover:bg-orange-700 duration-300 px-6 py-3 rounded-md bg-orange-600 block ml-4'>Buy Now</button>
                </div>
            ...
            <div className='w-[80%] mx-auto mt-16'>
                <h1 className='text-3xl font-semibold text-center'>Player Reviews({threeReviews.length})</h1>
