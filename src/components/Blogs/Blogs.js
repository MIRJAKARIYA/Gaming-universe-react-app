...
const Blogs = () => {
    return (
        <div className='mt-20'>
            <div className='lg:w-4/6 w-[95%] p-3 mx-auto mb-5 blog-style'>
            ...
            <div className='lg:w-4/6 w-[95%] p-3 mx-auto mb-5 blog-style'>
                <h1 className='text-3xl font-mono font-bold'>What are semantic HTML tags?</h1>
                ...
                Some Semantic tags: &lt;article&gt; , &lt;main&gt; , &lt;header&gt; , &lt;footer&gt; , &lt;section&gt; , &lt;aside&gt; , &lt;nav&gt;, &lt;summary&gt; etc.
                </p>
            </div>
            <div className='lg:w-4/6 w-[95%] p-3 mx-auto blog-style'>
                <h1 className='text-3xl font-mono font-bold'>What are the differences among inline,inline-block and block elements?</h1>
                <p className='text-xl font-semibold'>There are many differences among inline,inline-block and block elements.Some differences are shown below:</p>
